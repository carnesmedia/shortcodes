...
describe Shortcodes::Youtube do
  ...
  context 'with more options' do
    ...
    it 'generates a youtube embed code' do
      expected_content = '<iframe width="100" height="100" src="//www.youtube.com/embed/jyOSP36sHx0" frameborder="0" allowfullscreen></iframe>'
  ...
  context 'with a dash in the ID' do
    ...
    it 'generates a youtube embed code' do
      expected_content = '<iframe width="560" height="315" src="//www.youtube.com/embed/-EDor6UJuMI" frameborder="0" allowfullscreen></iframe>'
  ...
  context 'with a time in the url' do
    ...
    it 'generates a youtube embed code' do
      expected_content = '<iframe width="560" height="315" src="//www.youtube.com/embed/jyOSP36sHx0#t=2m30s" frameborder="0" allowfullscreen></iframe>'
